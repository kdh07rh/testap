                ...
                <div class="left" v-if="isOpenMenus">
                    <template v-for="menu in menus">
                        <template v-if="menu.text">
                            <div :class="[ 'menu', (menu.isChild ? 'sub' : 'main'), (menu.active ? 'active' : '') ]" v-if="!menu.isChild || (menu.isChild && menu.isOpen)">
                                <a @click.prevent="onClickMenuItem(menu, true)" v-html="menu.text"></a>
